...
try:
    if 'openai' in st.secrets:
        ...
        if 'assistant_id' not in st.session_state or not st.session_state.assistant_id:
    ...
    # Inicializar como None se não existirem no secrets
...
class PDFExtractor:
    ...
    def extrair_com_ocr_e_regex(self, texto, tipo_doc, caminho_pdf):
        ...
        if tipo_doc == "settlement_report":
            ...
            cabecalhos = ["ITEM", "QTY", "QUANTITY", "DESCRIPTION", "UNIT", "PRICE", "AMOUNT", "TOTAL"]
